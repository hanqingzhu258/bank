...
================================================== */
	...
	$('#deposit').click(function(e){
		if ($('#depositList').css("display")=="none") {
			$('#depositList').css("display","");
		}else{
	...
	$('#sideDeposit').click(function(e){
		if ($('#sideDepositList').css("display")=="none") {
			$('#sideDepositList').css("display","");
		}else{
			$('#sideDepositList').css("display","none");
		}

	});

	$('#withdraw').click(function(e){
		if ($('#withdrawList').css("display")=="none") {
			$('#withdrawList').css("display","");
		}else{
			$('#withdrawList').css("display","none");
		}

	});

	$('#sideWithdraw').click(function(e){
		if ($('#sideWithdrawList').css("display")=="none") {
			$('#sideWithdrawList').css("display","");
		}else{
			$('#sideWithdrawList').css("display","none");
		}
